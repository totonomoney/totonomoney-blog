---
title: "離婚後の名義変更・手続きをカテゴリ別に整理｜役所・保険・銀行の一覧"
date: 2026-04-09
draft: false
description: "離婚後の名義変更・手続きを役所・保険・年金・銀行などカテゴリ別に整理しました。どこで何を変えるかを場所ごとに把握したいシングルマザー向け。時系列で順番を知りたい方は別記事で解説しています。"
summary: "離婚後の名義変更・手続きを役所・保険・年金・銀行などカテゴリ別に整理しました。どこで何を変えるかを場所ごとに把握したいシングルマザー向け。時系列で順番を知りたい方は別記事で解説しています。"
...
この記事は**「どこで何を変えるか」を場所・カテゴリ別**に整理したものです。「当日から何を、いつまでに」という**時系列の順番**で全体像をつかみたい方は、まず[離婚当日からの時系列チェックリスト【完全版】](/posts/rikon-yarukoto-checklist/)を読んでから戻ってくると分かりやすいです。
...
保険全体の見直しは[シンママが離婚後に保険を見直した結果｜掛け捨てだけで十分だった理由](/posts/hoken-minaoshi/)も参考にしてください。
...
控除額や申請方法の詳細は[ひとり親控除とは？シングルマザーが申請すると税金がいくら減るか](/posts/hitorioya-kojin-koujyo/)で解説しています。
...
「養育費」「財産分与」「年金分割」など、自分だけで判断するのが不安な項目は、**弁護士の無料相談を1回使うだけ**でもまったく違います。話を聞くだけでもOK、依頼する義務はありません。

<!-- bengoshi-muryou-soudan公開後に戻す：弁護士無料相談の使い方は[弁護士の無料相談を使うときのポイントまとめ](/posts/bengoshi-muryou-soudan/)で解説しています。 -->

また、健康保険を切り替えるタイミングは、生命保険そのものを見直す絶好の機会でもあります。私自身、ここで保険を全部見直して月4〜5万円→数千円台になりました。どこで見直せばいいか迷ったら、[シンママ目線で無料相談3社を比較した記事](/posts/hoken-muryou-soudan/)を参考に、相談先を選んでみてください。
...
手続きを時系列順に確認したい方は[離婚後にやること完全チェックリスト【時系列順】](/posts/rikon-yarukoto-checklist/)もあわせてどうぞ。
...
離婚後の手続きで期限があるものから動いてください。

**「年金分割の手続きをしたかどうか確認する（離婚後2年以内）」**

期限を過ぎると一切できなくなります。

まだの方は今すぐ日本年金機構のサイトで確認してください。
